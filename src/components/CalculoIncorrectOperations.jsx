// src/components/CalculoIncorrectOperations.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoIncorrectOperations() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /IncorrectOperations pasando los datos
    navigate("/IncorrectOperations", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
