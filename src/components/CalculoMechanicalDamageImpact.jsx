// src/components/MechanicalDamageImpact.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function MechanicalDamageImpact() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /Cracking pasando los datos
    navigate("/Cracking", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
