// src/components/CalculoPigTrap.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoPigTrap() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /PigTrap pasando los datos
    navigate("/PigTrap", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
