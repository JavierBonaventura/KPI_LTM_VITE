// src/components/CalculoWeatherOutsideForcesWeather.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoWeatherOutsideForcesWeather() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /WeatherOutsideForcesWeather pasando los datos
    navigate("/WeatherOutsideForcesWeather", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
