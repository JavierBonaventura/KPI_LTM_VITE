// src/components/CalculoMechanicalDamageDetonations.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoMechanicalDamageDetonations() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /MechanicalDamageDetonations pasando los datos
    navigate("/MechanicalDamageDetonations", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
