// src/components/CalculoExternalCorrosion.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoExternalCorrosion() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /ExternalCorrosion pasando los datos
    navigate("/ExternalCorrosion", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
