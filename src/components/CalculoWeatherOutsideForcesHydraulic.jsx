// src/components/CalculoweatherOutsideForcesHydraulic.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoweatherOutsideForcesHydraulic() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /weatherOutsideForcesHydraulic pasando los datos
    navigate("/weatherOutsideForcesHydraulic", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
