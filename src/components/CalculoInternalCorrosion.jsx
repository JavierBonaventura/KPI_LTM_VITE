// src/components/CalculoInternalCorrosion.jsx
import { useEffect } from "react";
import { useLocation, useNavigate } from "react-router-dom";

export default function CalculoInternalCorrosion() {
  ...
  useEffect(() => {
    ...
    // Redirigir a /InternalCorrosion pasando los datos
    navigate("/InternalCorrosion", { state: resultadoConSegmentos });
  }, [resultado, navigate]);
