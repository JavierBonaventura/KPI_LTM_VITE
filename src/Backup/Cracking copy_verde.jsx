  ...
  return (
    <div className="bg-gray-50 text-gray-800 min-h-screen py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className="p-8 rounded-2xl shadow-2xl mb-8 border border-slate-700"
          style={{ background: "linear-gradient(to bottom, #265c4f, #16362e)" }}
        >
          ...
          <div className="text-center mb-6">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-[#3fa88a] to-[#2d7d67] mx-auto rounded-full"></div>
          </div>

          {/* Métricas principales */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Segmentos */}
            <div className="bg-emerald-950/40 border border-emerald-800 rounded-xl p-6 backdrop-blur-sm">
              ...
              <div className="mt-2 w-full bg-emerald-900/50 rounded-full h-2">
                <div
            ...
            <div className="bg-emerald-950/40 border border-emerald-800 rounded-xl p-6 backdrop-blur-sm">
              ...
              <div className="mt-2 w-full bg-emerald-900/50 rounded-full h-2">
                <div
                  className="bg-gradient-to-r from-emerald-400 to-emerald-600 h-2 rounded-full animate-pulse"
                  style={{ width: "92%" }}
                ></div>
              </div>
            </div>
      ...
      <div className="m-auto mt-8 flex justify-center max-w-7xl">
        <button
          className="px-8 py-4 bg-gradient-to-r from-emerald-700 to-emerald-800 text-white font-bold rounded-xl shadow-lg 
               hover:from-emerald-600 hover:to-emerald-700 transition duration-300 transform hover:scale-105 
               cursor-pointer border border-emerald-600"
          onClick={() => navigate("/")}
        >
